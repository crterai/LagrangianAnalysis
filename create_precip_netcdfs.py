...
model_output_location='/global/cscratch1/sd/terai/UP_analysis/Eastman_analysis/CAM5_1deg_run2/raw/'

model_prefix='longcam5I_L30_20081001_0Z_f09_g16_828'
derived_output_location='/global/cscratch1/sd/terai/UP_analysis/Eastman_analysis/CAM5_1deg_run2/precip/'
year='2009'
...
for i in months: #np.arange(4):
    ...
    for j in datestr:
        ...
        for k in timestr:
            ...
            outfile=''.join([derived_output_location,'PRECT_',model_prefix,'.cam.h1.',year,'-',mo_date,'-',date,'-',time,'.nc'])
            ...
            setattr(f_out,'script','create_precip_netcdfs.py')
